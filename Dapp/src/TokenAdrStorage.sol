...
contract EthereumTokenStorage is SafeMath, Ownable {

  /// Frozen tokens
  mapping(address => FrozenPortion) public frozenTokens;
  ...
  function EthereumTokenStorage (address _token, address _teamWallet, uint[] _freezePeriods, uint[] _freezePortions) public {
    require(_token > 0);
